...
const NOTHING_AVAILABLE = [
  ...
  "You cannot be sent the page's HTML, a DOM snapshot, or a screenshot: this app",
  "has no tool that returns one. Do not ask for any of them, and do not ask the",
  "user to paste them in.",
  "",
  "The run output may contain a line like \"Error Context: test-results/…/trace.zip\".",
  "That is Playwright naming a trace file. This app deletes its per-run scratch",
  "directory when the run ends, so that path no longer exists — do not cite it and",
  "do not ask the user to open it.",
  "",
