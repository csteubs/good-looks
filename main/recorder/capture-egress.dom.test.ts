...
import { ATTR_ASSERT, ATTR_PAUSED, SCROLL_CAPTURE_MIN_PX } from "./capture-script.js";
import { parseCaptureMessage } from "./capture-channel.js";
import { normalizeRawStep } from "./types.js";
// The page-with-the-script-installed harness, shared with typing-mode.dom.test.ts
// since 2026-08-21 — see the header of that module for why it is not a copy.
import { CAPTURE_NONCE as NONCE, captureHarness as harness } from "./capture-harness.js";
