...
import { normalizeTestIdAttributes, TESTID_ATTRIBUTE_OVERRIDES } from "../../shared/testid-attr.mjs";
...
// The locator engine — DOM_HELPERS, CONTEXT_HELPERS, UNIQUENESS_HELPERS and
// the scan caps — now lives in shared/locator-engine.mjs, imported above.
// It moved so an MCP or CLI run could embed it too: standing overlay rules
// and run-time Auto-Heal are both delivered as source text a Playwright
// worker evaluates, and neither could reach a module only the compiled app
// can import. See that file's header, and R49/R51 in the runner plan.
