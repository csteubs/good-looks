 ...
 * five files lost 229 lines that way, and the window MOVES whenever anyone
...
/** The scannable text of one file as a single string, for the by-name pins
 *  below, which ask whether a call is present rather than where. */
...

{
  ...
  // this replaced lost 77 lines of `recorder-service.ts` to the glob in
